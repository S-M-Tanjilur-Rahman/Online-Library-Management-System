...
<head>
<title>Welcome</title>
<link rel="stylesheet" href="aadcstyle.css">
	<meta charset="utf-8">
...
<body>
<img id="background" src="aadcbackground.jpg"/>
<div id="caption1">
...
<div id="container">
  <form action="" method="POST" class="form">
    Student id: <input type="text" name="id" placeholder="Student_id"><br /><br/>
...
<?php
  ...
  if(!empty($_POST['id'])){
    ...
    $query=mysql_query("SELECT * FROM user_info WHERE student_id='".$id."'");
    $numrows=mysql_num_rows($query);
    if($numrows!=0)
    {
      //$sql="INSERT INTO login(username,password) VALUES('$user','$pass')";

      $sql="DELETE FROM user_info WHERE student_id='".$id."'";
